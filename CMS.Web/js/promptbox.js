var promptbox = function () {
    ...
    this._Y = {};
    this._Z = false;
    this._00 = { "11": "A 股", "12": "B 股", "13": "权证", "14": "期货", "15": "债券", "21": "开基", "22": "ETF", "23": "LOF", "24": "货基", "25": "QDII",
        "26": "封基", "31": "港股", "32": "窝轮", "41": "美股", "42": "外期"
    };
    this._01 = { "inputid": null, "loader": null, "default": "", "type": 0, "max": 10, "width": 285, "link": null, "head": ["选项", "证券代码", "证券名称"], "body": [-1, 2, 4], "fix": { "firefox": [1, 1] }, "callback": null };
    this._02 = function (_a) { return document.getElementById(_a); };
    this._03 = function () { return (new Date()).getTime(); };
    ...
    this._06 = function () {
        ...
        { return "opera"; }
            ...
            if (_i.indexOf("MSIE 7.0") != -1) { return "ie7"; }
            else if (_i.indexOf("MSIE 6.0") != -1) { return "ie6"; }
            else if (_i.indexOf("MSIE") != -1) { return "ie"; } else { return "mozilla4"; }
        }
        else if (/^Mozilla\/5\.0.*/.test(_i) == true) {
            if (_i.indexOf("Chrome") != -1) { return "chrome"; }
            else if (_i.indexOf("Safari") != -1) { return "safari"; }
            else if (_i.indexOf("Firefox") != -1)
            { return "firefox"; } else { return "mozilla5"; }
    ...
    this._07 = function () {
        ...
        var _o = _m in this._01["fix"] ? this._01["fix"][_m] : [0, 0]; _o = [_n[0] + _o[0], _n[1] + _o[1]];
        if (this._S.style.top != _j + "px") { this._S.style.top = _j - _l[0] + _o[0] + "px"; }
        if (this._S.style.left != _k + "px") { this._S.style.left = _k - _l[1] + _o[1] + "px"; }
        ...
        if (this._S.style.marginTop != _r + "px") { this._S.style.marginTop = _r + "px"; }
    };
    this._09 = function (_g) { return { "1": "stock", "2": "fund", "3": "hk", "4": "us"}[_g.substr(0, 1)]; };
    this._0a = function () {
        ...
        if (("key_" + _s) in this._Y && this._Y["key_" + _s] != "") {
            ...
            var _t = '';
            _t += '<table style="border-collapse:collapse; line-height:25px; border:1px solid #d1d1d1; background-color:#ffffff; font-size:12px; text-align:center; color:#6d6d6d; width:' + (this._01["width"] - 2) + 'px;">'
            if (this._01["head"] != null) {
                _t += '<tr style="background-color:#f2f2f2;">';
                for (var i in this._01["head"])
                { _t += '<td>' + this._01["head"][i] + '</td>'; } _t += '</tr>';
            }
            ...
            for (var i = 0; i < _v; i++) {
                ...
                var _x = _u[i].split(",");
                _x[-1] = _x[0].replace(_s, '<span style="color:#ff0000;">' + _s + '</span>');
                _x[-2] = _x[1] in this._00 ? this._00[_x[1]] : "——";
                //alert(this.parentNode.parentNode.parentNode['suggest']['mouseoutLine'](this));
                ...
                for (var j in this._01["body"]) { _t += _y[0] + _x[this._01["body"][j]] + _y[1]; } _t += '</tr>';
            } _t += '</table>';
            this._X["key_" + _s] = _t;
            this._W = null;
    ...
    this._0e = function (_A) {
        var _B = "";
        if (_A._0f && _A._0g) { _B = "#F8FBDF"; } else if (_A._0f) { _B = "#F1F5FC"; } else if (_A._0g) { _B = "#C1DEE8"; }
        if (_A.style.backgroundColor != _B) { _A.style.backgroundColor = _B; }
    };
    this["mouseoverLine"] = function (_A) { _A._0g = true; this._0e(_A); };
    this["mouseoutLine"] = function (_A) { _A._0g = false; this._0e(_A); };
    this["setLineMouse"] = function (_A) {
        this["setLine"](_A);
        //alert(this._01.value)
        if (this._V != null) { this._V(this._08.value); }
    };
    this._0b = function (_C) {
        switch (_C[1]) {
            //            case "11": return _C[3]; break;     
            //            case "12": return _C[3]; break;     
            //            case "13": return _C[3]; break;     
            //            case "14": return _C[3]; break;     
            //            case "15": return _C[3]; break;     
            //            case "21": return _C[3]; break;     
            //            case "22": return _C[3]; break;     
            //            case "23": return _C[3]; break;     
            //            case "24": return _C[3]; break;     
            //            case "25": return _C[3]; break;     
            //            case "26": return _C[3]; break;     
            default: return _C[2]; break;
        }
    };
    this["setLine"] = function (_A) {
        ...
        var _C = _A.id.split(",");
        //alert(_C[4]);
        var _D = this._0b(_C); this._U = _D;

        this._08.value = _D + "|" + _C[4];
        if (this._W != null) {
            this._W._0f = false; this._0e(this._W);
        } _A._0f = true;
        this._0e(_A); this._W = _A;
    };
    this._0c = function () {
        if (this._S != null) {
    ...
    this._0i = function (_s, _E, _F) {
        ...
        _H.type = "text/javascript"; _H.charset = "gb2312";
        ...
        _H[document.all ? "onreadystatechange" : "onload"] = function () {
            ...
            if (typeof _I != "undefined") {
                ...
                this._0k(_I); window[this._0n] = null;
            } else if (this._0o)
            { this._0o(""); }
            this._0j = null;
            this._0m = null;
    ...
    this._0p = function () {
        ...
        if (this._U != _s) {
            this._U = _s; if (_s != "") {
                ...
                if (this._S != null) {
                    this._W = null; this._S.innerHTML = "";
                }
                this._0d();
            }
        } else { this._0c(); }
    ...
    this._0q = function () {
        if (this._08.value == this._T) { this._08.value = ""; }
        this._U = ""; this._0p();
    };
    this._0r = function () {
        // if (this._08.value == "") {  this._08.value = this._T; };
        this._U = ""; this._0d();
    };
    this._0s = function () {
        ...
        switch (_J.keyCode) {
            case 38: if (this._S != null) {
                    this["setLine"](this._S.firstChild.rows[(!this._W || this._W.rowIndex == _K) ? this._S.firstChild.rows.length - 1 : this._W.rowIndex - 1]);
                } break;
            case 40: if (this._S != null) {
                    this["setLine"](this._S.firstChild.rows[(!this._W || this._W.rowIndex == this._S.firstChild.rows.length - 1) ? _K : this._W.rowIndex + 1]);
                } break;
            case 13: if (this._S != null) {
                    if (this._W != null) { this["setLine"](this._W); }
                    if (this._V != null) { this._V(this._08.value); }
                } this._0d(); break;
            default: this._0p(); break;
        }
    };
    this.getCodeFromCache = function (_s) { if (("key_" + _s) in this._Y) { return this._Y["key_" + _s]; } };
    this.getCode = function (_s, _L) {
        if (("key_" + _s) in this._Y) { _L(this._Y["key_" + _s]); }
        else { this._0i(_s, _L, _L); }
    };
    this.changeType = function (_g) {
        ...
        if (typeof _g != "undefined") {
            ...
            switch (_g.toLowerCase()) {
                case "stock": _M = "11,12,13,14,15"; break;

                case "fund": _M = "21,22,23,24,25,26"; break;
                case "hkstock": _M = "31"; break;
                case "hk": _M = "31,32"; break;
                case "usstock": _M = "41"; break;
                case "us": _M = "41,42"; break;
                default: _M = _g; break;
            }
            this._Q = this._P.replace("@TYPE@", _M);
        }
        else { this._Q = this._P.replace("type=@TYPE@&", ""); }
        this._01["type"] = _g;
    };
    this.changeLink = function (_N) {
        this._01["link"] = _N; this._0a(); this._0d();
    };
    this.bind = function (_O) {
        if (typeof _O != "undefined") {
            for (var i in _O) { this._01[i] = _O[i]; }
        }
        this._08 = typeof this._01["inputid"] == "string" ? document.getElementById(this._01["inputid"]) : this._01["inputid"];
...
var Common = {
    ...
    CheckDate: function (date) {
        var regular = /^(\d{1,4})(-)([0-1]{1})(\d{1})(-)([0-3]{1})(\d{1})/
        if (!regular.test(date)) {
            alert("您输入的日期格式不正确!")
            return false;
        }
        else
    ...
    //校验证券代码仅限A股6位数字代码
    CheckStockcode: function (stockcode) {
        var regular = /^[0-9]{6}$/;
        if (!regular.test(stockcode)) {
            alert("您输入的股票代码格式不正确!")
            return false;
        }
        else
