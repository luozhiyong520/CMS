...
<%-- <script src="/themes/default/scripts/jquery-easyui-1.2/easyui-lang-zh_CN.js" type="text/javascript"></script>
...
<body>
   <div class="con_p">
       ...
       <div class="cz_bk">
         ...
         <TABLE class="c_table" cellSpacing=0 cellPadding=0 width="100%" align=center border=0>        
            <TR>
                <TD colspan="7" align="left"  class="tr_line">&nbsp;&nbsp;&nbsp;&nbsp;
                <input class="inButton" type="Button" name="Button1" id="Button1" value="全选/反选" onclick="setChecked();" />&nbsp;&nbsp;
                <input class="inButton" type="submit" name="bulkInsert" id="bulkInsert" value="批量插入" disabled="disabled" />&nbsp;&nbsp;
                <input type="submit" class='easyui-linkbutton l-btn l-btn-plain' plain="true" iconCls='icon-add' id="MediaInfo" value="上传图片"/>&nbsp;&nbsp;
            </TR>
        </TABLE>
 ...
 <div id="MediaAddEdit" title="文件" class="easyui-draggable" data-options="handle:'#title'" style="height:450px; display:none; position:absolute; left:50px;top:40px; width:800px;border:1px solid #99BBE8;background:transparent url(/themes/default/scripts/jquery-easyui-1.3/themes/default/images/panel_title.png); padding:5px; "> 
      <div style="height:32px; line-height:24px; font-weight:bold;"  id="title">
         <div style="float:left; padding-left:20px;">添加图片</div>
         <a style="float:right; padding-right:20px;" href="javascript:void(0)" id="closepic">关闭</a>
      </div>
      <div style="clear:both"></div>
      <div style="height:410px; overflow:auto; background:#ffffff;">
    <table width="100%" border="0" cellpadding="4" cellspacing="1" class="tdBorder">
        ...
        <tr class="tdc1">
          <td colspan="3"><font color="red">
            ...
            注：文件只能上传到子分类中,上传图片，点击"选择本地图片（单图最大为 2048KB，支持多选）"按钮后会自动判断文件大小自动上传，上传成功后可以直接关闭本窗口，如需插入到录入页面编辑器中，请点击"插入图片到编辑框中"按钮</font></td>
        </tr>
