$(function () {
    ...
    $("#btnAddtemplate").click(function () {
        ...
        ShowEditItemDialog('', 'divbody', 920, 550, function (j_dialog) { InsertPageTemplate(j_dialog); });
        return false;
    });
    //查询
    ...
    $('#pgTemp').datagrid({
        ...
        columns: [[
			 ...
			 { title: "<b>创建人</b>", field: "CreatedUser", align: 'center', width: fillSize(0.05) },
              ...
              { title: "<b>站点名称</b>", field: "SiteName", align: 'center', width: fillSize(0.05) },
...
function ShowPageTemplate() {
    ...
    $.ajax({
        ...
        success: function (json) {
            ...
            // 显示编辑对话框
            ShowEditItemDialog(templateId, 'divbody', 920, 550, function (j_dialog) {
                // 验证输入
                if (ValidateForm()) {
                    var j_waitDialog = ShowWaitMessageDialog();
                    var templateName = $("#txtTemplateName").val();
