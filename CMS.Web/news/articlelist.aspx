      ...
      <div class="lm_div">管理选项</div>
        <div class="cz_xx">
           ...
           | <a href="#"  class='easyui-linkbutton l-btn l-btn-plain' plain="true" iconCls='icon-add'>添加文件下载</a> 
            ...
            | <a name="Submit4" id="Submit4"  class='easyui-linkbutton l-btn l-btn-plain' plain="true" iconCls='icon-edit'/>选择生成</a> 
            | <a name="Submit5" id="Submit5"  class='easyui-linkbutton l-btn l-btn-plain' plain="true" iconCls='icon-edit'/>一键生成</a> 
            | <a name="Submit6" id="Submit6"  class='easyui-linkbutton l-btn l-btn-plain' plain="true" iconCls='icon-edit'/>按栏目生成</a> 
             | <a name="Submit7" id="Submit7"  class='easyui-linkbutton l-btn l-btn-plain' plain="true" iconCls='icon-edit'/>未生成</a> 
        </div>
    </div>
