...
<body>
            ...
            <TR>
              ...
              <TD colspan="3">&nbsp;&nbsp;<IMG height="16" src="/themes/default/images/admin/Item.Doc.Update.gif" width="16" align="absMiddle">
                ...
                标题图片:<span id="spanButtonImage"></span> <span id="imagesrc"><input type='hidden' value="<%=Model.News.ImgUrl%> " name='ImgUrl'/></span>
                 切换图片:<span id="spanButtonImage1"></span> <span id="imagesrc1"><input type='hidden' value="<%=Model.News.TabImgUrl%> " name='TabImgUrl'/></span>
               </TD>
            </TR>
    ...
    <script type="text/javascript">
        ...
        function uploadSuccess2(file, serverData) {
            var imgsrc = $("#imagesrc1>input:first").attr("value");
            $("#imagesrc1").html("<img src=" + serverData + " width=60px height=80px/><input type='hidden' value=" + serverData + " name='ImgUrl'/> ");
