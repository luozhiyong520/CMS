            ...
            <TR>
              ...
              <TD colspan="3"> 
               <div style="position:relative; margin-left:10px">
                ...
                切换图片:<span style=""><span id="spanButtonImage1"></span> <span id="imagesrc1"></span></span>
                </div>
               </TD>
            </TR>
              <TR>
		...
		window.onload = function () {
			swfu = new SWFUpload({
             ...
             swfupic1 = new SWFUpload({
                    ...
                    // Button settings
                    //button_image_url : "images/XPButtonNoText_160x22.png",
                    button_placeholder_id: "spanButtonImage1",
                    button_width: 80,
                    button_height: 28,
                    button_text: '<span class="button">点击上传图片</span> ',
                    button_text_style: '.button { color:#ff0000; padding-right:20px }',
         ...
         function uploadSuccess2(file, serverData) {
             var imgsrc = $("#imagesrc1 img").length;
             if (imgsrc == 0) {
                 $("#imagesrc1").append("<img src=" + serverData + " width=60px height=80px/><input type='hidden' value=" + serverData + " name='TabImgUrl'/> ");
             }
             else {
                 $("#imagesrc1").html("<img src=" + serverData + " width=60px height=80px/><input type='hidden' value=" + serverData + " name='TabImgUrl'/>");
                 // $("#imagesrc>input:first").attr({ value: serverData });
             }
             $("#imagesrc1").append("<span onclick='delImg1()' style='color:red;padding-left:10px;cursor:pointer;'>删除</span>");
             $("#addArticle").attr("disabled", false)
         };
         ...
         function delImg() {
             ...
             $("#imagesrc>img").remove();
             var stats = swfupic.getStats();
             stats.successful_uploads--;
             swfupic.setStats(stats);
         }
         function delImg1() {
             $("#imagesrc1>span").remove();
             $("#imagesrc1>img").remove();
             var stats = swfupic1.getStats();
             stats.successful_uploads--;
             swfupic1.setStats(stats);
         }
         function delFile() {
