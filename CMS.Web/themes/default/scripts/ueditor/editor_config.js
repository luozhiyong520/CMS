...
(function () {
    ...
    */
    window.UEDITOR_HOME_URL = 'themes/default/scripts/ueditor/';
    var URL;
    /**
   ...
   URL = window.UEDITOR_HOME_URL || tmp.substr(0, tmp.lastIndexOf("\/") + 1).replace("fragment/", "").replace("website/", ""); //这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
   // URL = '/themes/default/scripts/ueditor/';
    /**
