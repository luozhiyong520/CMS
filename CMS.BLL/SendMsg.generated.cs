...
{	
	public partial class SendMsgBLL 	{
		private static readonly SendMsgDAL dal = Factory.DataFactory.CreateDAL<SendMsgDAL>();
        ...
        /// </summary>
        /// <returns></returns>
        public SendMsg Get(string colName,object value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public SendMsg Get(Dictionary<string, object> keyProps)
        {
        ...
        /// <returns></returns>
        public List<SendMsg> GetAll(SqlWhereList where)
        {
