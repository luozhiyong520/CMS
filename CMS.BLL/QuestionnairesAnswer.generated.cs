...
{	
	public partial class QuestionnairesAnswerBLL 	{
		private static readonly QuestionnairesAnswerDAL dal = Factory.DataFactory.CreateDAL<QuestionnairesAnswerDAL>();
        ...
        /// <returns></returns>
        public int Add(QuestionnairesAnswer obj)
        {
            return dal.Add(obj);
        }
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Update(QuestionnairesAnswer obj)
        {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Delete(QuestionnairesAnswer obj)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public QuestionnairesAnswer Get(string colName,object value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public QuestionnairesAnswer Get(Dictionary<string, object> keyProps)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<QuestionnairesAnswer> GetAll()
        {
            return dal.GetAll();
        }
        ...
        /// <returns></returns>
        public List<QuestionnairesAnswer> GetAll(SqlWhereList where)
        {
