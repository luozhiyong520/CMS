...
namespace CMS.BLL
{	
	public partial class PopupMsgStatisticsBLL 	{
		private static readonly PopupMsgStatisticsDAL dal = Factory.DataFactory.CreateDAL<PopupMsgStatisticsDAL>();
        ...
        /// <returns></returns>
        public int Add(PopupMsgStatistics obj)
        {
            return dal.Add(obj);
        }
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Update(PopupMsgStatistics obj)
        {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Delete(PopupMsgStatistics obj)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public PopupMsgStatistics Get(string colName,object value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public PopupMsgStatistics Get(Dictionary<string, object> keyProps)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<PopupMsgStatistics> GetAll()
        {
            return dal.GetAll();
        }
        ...
        /// <returns></returns>
        public List<PopupMsgStatistics> GetAll(SqlWhereList where)
        {
