...
namespace CMS.BLL
{	
	public partial class NewsStockRelationBLL 	{
		private static readonly NewsStockRelationDAL dal = Factory.DataFactory.CreateDAL<NewsStockRelationDAL>();
        ...
        /// <returns></returns>
        public int Add(NewsStockRelation obj)
        {
            return dal.Add(obj);
        }
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Update(NewsStockRelation obj)
        {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Delete(NewsStockRelation obj)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public NewsStockRelation Get(string colName,object value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public NewsStockRelation Get(Dictionary<string, object> keyProps)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<NewsStockRelation> GetAll()
        {
            return dal.GetAll();
        }
        ...
        /// <returns></returns>
        public List<NewsStockRelation> GetAll(SqlWhereList where)
        {
