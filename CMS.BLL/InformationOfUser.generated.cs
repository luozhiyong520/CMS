...
namespace CMS.BLL
{	
	public partial class InformationOfUserBLL 	{
		private static readonly InformationOfUserDAL dal = Factory.DataFactory.CreateDAL<InformationOfUserDAL>();
        ...
        /// <returns></returns>
        public int Add(InformationOfUser obj)
        {
            return dal.Add(obj);
        }
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Update(InformationOfUser obj)
        {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Delete(InformationOfUser obj)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public InformationOfUser Get(string colName,object value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public InformationOfUser Get(Dictionary<string, object> keyProps)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<InformationOfUser> GetAll()
        {
            return dal.GetAll();
        }
        ...
        /// <returns></returns>
        public List<InformationOfUser> GetAll(SqlWhereList where)
        {
