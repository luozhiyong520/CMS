...
namespace CMS.BLL
{	
	public partial class AdminMenuModuleBLL 	{
		private static readonly AdminMenuModuleDAL dal = Factory.DataFactory.CreateDAL<AdminMenuModuleDAL>();
        ...
        /// <returns></returns>
        public int Add(AdminMenuModule obj)
        {
            return dal.Add(obj);
        }
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Update(AdminMenuModule obj)
        {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Delete(AdminMenuModule obj)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public AdminMenuModule Get(string colName,object value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public AdminMenuModule Get(Dictionary<string, object> keyProps)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<AdminMenuModule> GetAll()
        {
            return dal.GetAll();
        }
        ...
        /// <returns></returns>
        public List<AdminMenuModule> GetAll(SqlWhereList where)
        {
