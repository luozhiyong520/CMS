...
{	
	public partial class QuestionnairesOptionsBLL 	{
		private static readonly QuestionnairesOptionsDAL dal = Factory.DataFactory.CreateDAL<QuestionnairesOptionsDAL>();
        ...
        /// <returns></returns>
        public int Add(QuestionnairesOptions obj)
        {
            return dal.Add(obj);
        }
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Update(QuestionnairesOptions obj)
        {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Delete(QuestionnairesOptions obj)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public QuestionnairesOptions Get(string colName,object value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public QuestionnairesOptions Get(Dictionary<string, object> keyProps)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<QuestionnairesOptions> GetAll()
        {
            return dal.GetAll();
        }
        ...
        /// <returns></returns>
        public List<QuestionnairesOptions> GetAll(SqlWhereList where)
        {
