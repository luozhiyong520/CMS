...
namespace CMS.BLL
{	
	public partial class TransStatisticsBLL 	{
		private static readonly TransStatisticsDAL dal = Factory.DataFactory.CreateDAL<TransStatisticsDAL>();
        ...
        /// <returns></returns>
        public int Add(TransStatistics obj)
        {
            return dal.Add(obj);
        }
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Update(TransStatistics obj)
        {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Delete(TransStatistics obj)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public TransStatistics Get(string colName,object value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public TransStatistics Get(Dictionary<string, object> keyProps)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<TransStatistics> GetAll()
        {
            return dal.GetAll();
        }
        ...
        /// <returns></returns>
        public List<TransStatistics> GetAll(SqlWhereList where)
        {
