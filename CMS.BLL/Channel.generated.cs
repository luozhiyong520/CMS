...
{	
	public partial class ChannelBLL 	{
		private static readonly ChannelDAL dal = Factory.DataFactory.CreateDAL<ChannelDAL>();
        ...
        /// </summary>
        /// <returns></returns>
        public Channel Get(string colName,object value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Channel Get(Dictionary<string, object> keyProps)
        {
        ...
        /// <returns></returns>
        public List<Channel> GetAll(SqlWhereList where)
        {
