...
{	
	public partial class ActualsAssociateBLL 	{
		private static readonly ActualsAssociateDAL dal = Factory.DataFactory.CreateDAL<ActualsAssociateDAL>();
        ...
        /// <returns></returns>
        public int Add(ActualsAssociate obj)
        {
            return dal.Add(obj);
        }
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Update(ActualsAssociate obj)
        {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Delete(ActualsAssociate obj)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public ActualsAssociate Get(string colName,object value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public ActualsAssociate Get(Dictionary<string, object> keyProps)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<ActualsAssociate> GetAll()
        {
            return dal.GetAll();
        }
        ...
        /// <returns></returns>
        public List<ActualsAssociate> GetAll(SqlWhereList where)
        {
