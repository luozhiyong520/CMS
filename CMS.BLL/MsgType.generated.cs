...
{	
	public partial class MsgTypeBLL 	{
		private static readonly MsgTypeDAL dal = Factory.DataFactory.CreateDAL<MsgTypeDAL>();
        ...
        /// </summary>
        /// <returns></returns>
        public MsgType Get(string colName,object value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public MsgType Get(Dictionary<string, object> keyProps)
        {
        ...
        /// <returns></returns>
        public List<MsgType> GetAll(SqlWhereList where)
        {
