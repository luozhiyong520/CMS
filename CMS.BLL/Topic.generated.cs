...
{	
	public partial class TopicBLL 	{
		private static readonly TopicDAL dal = Factory.DataFactory.CreateDAL<TopicDAL>();
        ...
        /// </summary>
        /// <returns></returns>
        public Topic Get(string colName,object value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Topic Get(Dictionary<string, object> keyProps)
        {
        ...
        /// <returns></returns>
        public List<Topic> GetAll(SqlWhereList where)
        {
