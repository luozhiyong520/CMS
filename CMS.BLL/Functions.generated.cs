...
namespace CMS.BLL
{	
	public partial class FunctionsBLL 	{
		private static readonly FunctionsDAL dal = Factory.DataFactory.CreateDAL<FunctionsDAL>();
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Update(Functions obj)
        {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Delete(Functions obj)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Functions Get(string colName,object value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Functions Get(Dictionary<string, object> keyProps)
        {
        ...
        /// <returns></returns>
        public List<Functions> GetAll(SqlWhereList where)
        {
