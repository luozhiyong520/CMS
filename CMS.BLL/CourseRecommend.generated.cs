...
{	
	public partial class CourseRecommendBLL 	{
		private static readonly CourseRecommendDAL dal = Factory.DataFactory.CreateDAL<CourseRecommendDAL>();
        ...
        /// <returns></returns>
        public int Add(CourseRecommend obj)
        {
            return dal.Add(obj);
        }
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Update(CourseRecommend obj)
        {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Delete(CourseRecommend obj)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public CourseRecommend Get(string colName,object value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public CourseRecommend Get(Dictionary<string, object> keyProps)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<CourseRecommend> GetAll()
        {
            return dal.GetAll();
        }
        ...
        /// <returns></returns>
        public List<CourseRecommend> GetAll(SqlWhereList where)
        {
