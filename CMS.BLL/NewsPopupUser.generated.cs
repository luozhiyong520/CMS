...
namespace CMS.BLL
{	
	public partial class NewsPopupUserBLL 	{
		private static readonly NewsPopupUserDAL dal = Factory.DataFactory.CreateDAL<NewsPopupUserDAL>();
        ...
        /// <returns></returns>
        public int Add(NewsPopupUser obj)
        {
            return dal.Add(obj);
        }
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Update(NewsPopupUser obj)
        {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Delete(NewsPopupUser obj)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public NewsPopupUser Get(string colName,object value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public NewsPopupUser Get(Dictionary<string, object> keyProps)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<NewsPopupUser> GetAll()
        {
            return dal.GetAll();
        }
        ...
        /// <returns></returns>
        public List<NewsPopupUser> GetAll(SqlWhereList where)
        {
