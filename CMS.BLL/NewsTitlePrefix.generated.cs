...
{	
	public partial class NewsTitlePrefixBLL 	{
		private static readonly NewsTitlePrefixDAL dal = Factory.DataFactory.CreateDAL<NewsTitlePrefixDAL>();
        ...
        /// <returns></returns>
        public int Add(NewsTitlePrefix obj)
        {
            return dal.Add(obj);
        }
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Update(NewsTitlePrefix obj)
        {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Delete(NewsTitlePrefix obj)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public NewsTitlePrefix Get(string colName,object value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public NewsTitlePrefix Get(Dictionary<string, object> keyProps)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<NewsTitlePrefix> GetAll()
        {
            return dal.GetAll();
        }
        ...
        /// <returns></returns>
        public List<NewsTitlePrefix> GetAll(SqlWhereList where)
        {
