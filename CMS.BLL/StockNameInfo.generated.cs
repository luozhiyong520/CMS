...
namespace CMS.BLL
{	
	public partial class StockNameInfoBLL 	{
		private static readonly StockNameInfoDAL dal = Factory.DataFactory.CreateDAL<StockNameInfoDAL>();
        ...
        /// <returns></returns>
        public int Add(StockNameInfo obj)
        {
            return dal.Add(obj);
        }
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Update(StockNameInfo obj)
        {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Delete(StockNameInfo obj)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public StockNameInfo Get(string colName,object value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public StockNameInfo Get(Dictionary<string, object> keyProps)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<StockNameInfo> GetAll()
        {
            return dal.GetAll();
        }
        ...
        /// <returns></returns>
        public List<StockNameInfo> GetAll(SqlWhereList where)
        {
