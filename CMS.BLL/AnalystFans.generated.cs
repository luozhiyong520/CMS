...
namespace CMS.BLL
{	
	public partial class AnalystFansBLL 	{
		private static readonly AnalystFansDAL dal = Factory.DataFactory.CreateDAL<AnalystFansDAL>();
        ...
        /// <returns></returns>
        public int Add(AnalystFans obj)
        {
            return dal.Add(obj);
        }
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Update(AnalystFans obj)
        {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Delete(AnalystFans obj)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public AnalystFans Get(string colName,object value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public AnalystFans Get(Dictionary<string, object> keyProps)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<AnalystFans> GetAll()
        {
            return dal.GetAll();
        }
        ...
        /// <returns></returns>
        public List<AnalystFans> GetAll(SqlWhereList where)
        {
