...
namespace CMS.BLL
{	
	public partial class AppDownloadBLL 	{
		private static readonly AppDownloadDAL dal = Factory.DataFactory.CreateDAL<AppDownloadDAL>();
        ...
        /// <returns></returns>
        public int Add(AppDownload obj)
        {
            return dal.Add(obj);
        }
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Update(AppDownload obj)
        {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Delete(AppDownload obj)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public AppDownload Get(string colName,object value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public AppDownload Get(Dictionary<string, object> keyProps)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<AppDownload> GetAll()
        {
            return dal.GetAll();
        }
        ...
        /// <returns></returns>
        public List<AppDownload> GetAll(SqlWhereList where)
        {
