...
{	
	public partial class SSOResultBLL 	{
		private static readonly SSOResultDAL dal = Factory.DataFactory.CreateDAL<SSOResultDAL>();
        ...
        /// </summary>
        /// <returns></returns>
        public SSOResult Get(string colName,object value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public SSOResult Get(Dictionary<string, object> keyProps)
        {
        ...
        /// <returns></returns>
        public List<SSOResult> GetAll(SqlWhereList where)
        {
