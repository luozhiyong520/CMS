...
namespace CMS.BLL
{	
	public partial class AuthorityDotAdminBLL 	{
		private static readonly AuthorityDotAdminDAL dal = Factory.DataFactory.CreateDAL<AuthorityDotAdminDAL>();
        ...
        /// <returns></returns>
        public int Add(AuthorityDotAdmin obj)
        {
            return dal.Add(obj);
        }
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Update(AuthorityDotAdmin obj)
        {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Delete(AuthorityDotAdmin obj)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public AuthorityDotAdmin Get(string colName,object value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public AuthorityDotAdmin Get(Dictionary<string, object> keyProps)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<AuthorityDotAdmin> GetAll()
        {
            return dal.GetAll();
        }
        ...
        /// <returns></returns>
        public List<AuthorityDotAdmin> GetAll(SqlWhereList where)
        {
