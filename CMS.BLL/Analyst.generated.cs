...
{	
	public partial class AnalystBLL 	{
		private static readonly AnalystDAL dal = Factory.DataFactory.CreateDAL<AnalystDAL>();
        ...
        /// </summary>
        /// <returns></returns>
        public Analyst Get(string colName,object value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Analyst Get(Dictionary<string, object> keyProps)
        {
        ...
        /// <returns></returns>
        public List<Analyst> GetAll(SqlWhereList where)
        {
