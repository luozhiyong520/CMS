...
namespace CMS.BLL
{	
	public partial class ReceiveMsgBLL 	{
		private static readonly ReceiveMsgDAL dal = Factory.DataFactory.CreateDAL<ReceiveMsgDAL>();
        ...
        /// </summary>
        /// <returns></returns>
        public ReceiveMsg Get(string colName,object value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public ReceiveMsg Get(Dictionary<string, object> keyProps)
        {
        ...
        /// <returns></returns>
        public List<ReceiveMsg> GetAll(SqlWhereList where)
        {
