...
namespace CMS.BLL
{	
	public partial class TemplateBLL 	{
		private static readonly TemplateDAL dal = Factory.DataFactory.CreateDAL<TemplateDAL>();
        ...
        /// </summary>
        /// <returns></returns>
        public Template Get(string colName,object value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Template Get(Dictionary<string, object> keyProps)
        {
        ...
        /// <returns></returns>
        public List<Template> GetAll(SqlWhereList where)
        {
