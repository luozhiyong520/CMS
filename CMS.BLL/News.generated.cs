...
{	
	public partial class NewsBLL 	{
		private static readonly NewsDAL dal = Factory.DataFactory.CreateDAL<NewsDAL>();
        ...
        /// </summary>
        /// <returns></returns>
        public News Get(Dictionary<string, object> keyProps)
        {
        ...
        /// <returns></returns>
        public List<News> GetAll(SqlWhereList where)
        {
