...
{	
	public partial class MediaBLL 	{
		private static readonly MediaDAL dal = Factory.DataFactory.CreateDAL<MediaDAL>();
        ...
        /// </summary>
        /// <returns></returns>
        public Media Get(string colName,object value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Media Get(Dictionary<string, object> keyProps)
        {
        ...
        /// <returns></returns>
        public List<Media> GetAll(SqlWhereList where)
        {
