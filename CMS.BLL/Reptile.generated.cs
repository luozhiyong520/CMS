...
namespace CMS.BLL
{	
	public partial class ReptileBLL 	{
		private static readonly ReptileDAL dal = Factory.DataFactory.CreateDAL<ReptileDAL>();
        ...
        /// </summary>
        /// <returns></returns>
        public Reptile Get(string colName,object value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Reptile Get(Dictionary<string, object> keyProps)
        {
        ...
        /// <returns></returns>
        public List<Reptile> GetAll(SqlWhereList where)
        {
