...
namespace CMS.BLL
{	
	public partial class NewsContentBLL 	{
		private static readonly NewsContentDAL dal = Factory.DataFactory.CreateDAL<NewsContentDAL>();
        ...
        /// <returns></returns>
        public int Add(NewsContent obj)
        {
            return dal.Add(obj);
        }
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Update(NewsContent obj)
        {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Delete(NewsContent obj)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public NewsContent Get(string colName,object value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public NewsContent Get(Dictionary<string, object> keyProps)
        {
        ...
        /// <returns></returns>
        public List<NewsContent> GetAll(SqlWhereList where)
        {
