...
namespace CMS.BLL
{	
	public partial class DirectionBLL 	{
		private static readonly DirectionDAL dal = Factory.DataFactory.CreateDAL<DirectionDAL>();
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Update(Direction obj)
        {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public int Delete(Direction obj)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Direction Get(string colName,object value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Direction Get(Dictionary<string, object> keyProps)
        {
        ...
        /// <returns></returns>
        public List<Direction> GetAll(SqlWhereList where)
        {
