     ...
     <script type="text/javascript">
         ...
         function BataDataList() {
             $('#pgAnalyst').datagrid({
                 ...
                 showPageList: true,
                 fitColumns: true,
                 url: '/AjaxAnalyst/Analystlist.cspx?AnalystType=1',
                 columns: [[
             ...
             { title: "<b>操作</b>", field: "xx2", align: 'center', width: fillSize(0.2),
                 formatter: function (value, row) {
                     var productButtonHtml = '<a href="analystinfo.aspx?type=1&AnalystId=' + row.AnalystId + '&AnalystType=' + row.AnalystType + '"   class="easyui-linkbutton l-btn l-btn-plain" plain="true" iconCls="icon-edit">个人管理</a>&nbsp;&nbsp;';
                     return productButtonHtml + '<a  href="zbadd.aspx?AnalystId=' + row.AnalystId + '&AnalystName=' + encodeURI(row.AnalystName) + '&AnalystType=' + row.AnalystType + '"  class="easyui-linkbutton l-btn l-btn-plain" plain="true" iconCls="icon-edit">直播管理</a><a href="http://app.upchina.com/sasweb/xysidkdydnhensydn_cdhds.dyshg/dsfyewlrndsfpoidsfewlkdsnf.cxgdsf_hdsfnew_gz/analystlive/exclusive.html?AnalystId=' + row.AnalystId + '"   class="easyui-linkbutton l-btn l-btn-plain" plain="true" iconCls="icon-edit" target="_blank">我的个人页</a>&nbsp;&nbsp;';
...
<body>
    <div class="con_p"> 
      ...
      <div class="lm_div">管理选项</div>
        <div class="cz_xx">
           <a href="analystlist.aspx" class='easyui-linkbutton l-btn l-btn-plain' plain="true" iconCls='icon-add'>现货分析师列表</a>
          <%-- |<a href="analystadd.aspx" class='easyui-linkbutton l-btn l-btn-plain' plain="true" iconCls='icon-add'>添加个人信息</a>--%>
        </div>
    </div>
