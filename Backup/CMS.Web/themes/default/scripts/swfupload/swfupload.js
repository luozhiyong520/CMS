...
SWFUpload.prototype.callFlash = function (functionName, argumentArray) {
	...
	try {
	    if (movieElement != undefined) {
	      //alert('<invoke name="' + functionName + '" returntype="javascript">' + __flash__argumentsToXML(argumentArray, 0) + '</invoke>')
    ...
    //alert("Exception calling flash function '" + functionName + "': " + ex.message)
