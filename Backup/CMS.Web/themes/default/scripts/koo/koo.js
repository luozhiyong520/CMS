...
(function () {
    $.fn.Koo= function (callback,ts) {
        ...
        function validateField(field, temp) {
            ...
            var val = $(field).val();
			var defaultvalue;
			if ($(field).attr('defaultvalue') != undefined && $(field).attr('defaultvalue') != '') { defaultvalue = $(field).attr('defaultvalue') }
