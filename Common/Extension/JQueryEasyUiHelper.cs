...
namespace Common
{
	...
	public static class JQueryEasyUiHelper
	{
		...
		public static string ToHtml(this PagingInfo pagingInfo, string urlParamName)
		{
			...
			MyUrlGenerator generate = new MyUrlGenerator(SMVC.HttpContextHelper.RequestRawUrl);
			...
			string labRefresh = GenerateButton("pagination-load", SMVC.HttpContextHelper.RequestRawUrl, "刷新", true, "刷新当前页");
